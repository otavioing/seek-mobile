        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
                    <View style={styles.containerfilter}>
                        ...
                        <Text style={{fontSize:32, fontWeight:800, color:"#FFFFFF",}}>Ferramentas</Text>
                        ...
                        <Text style={{fontSize:32, fontWeight:800, color:"#FFFFFF",}}>Cor</Text>
                         <View style={styles.fbtContainer}>
                            <View style={{flexDirection:'row', alignItems:'center',justifyContent:'space-between',width:'45%',}}>
                                <Text style={styles.textoFiltro}>Vermelho</Text>
                        ...
                        <View style={styles.fbtContainer}>
                            <View style={{flexDirection:'row', alignItems:'center',justifyContent:'space-between',width:'45%',}}>
                                <Text style={styles.textoFiltro}>Verde</Text>
                        ...
                        <View style={styles.fbtContainer}>
                            <View style={{flexDirection:'row', alignItems:'center',justifyContent:'space-between',width:'45%',}}>
                                <Text style={styles.textoFiltro}>Azul</Text>
                        ...
                        <View style={styles.fbtContainer}>
                            <View style={{flexDirection:'row', alignItems:'center',justifyContent:'space-between',width:'45%',}}>
                                <Text style={styles.textoFiltro}>Amarelo</Text>
                        ...
                        <View style={styles.fbtContainer}>
                            <View style={{flexDirection:'row', alignItems:'center',justifyContent:'space-between',width:'45%',}}>
                                <Text style={styles.textoFiltro}>Roxo</Text>
