...
import { FilterTheme, getFilterVTheme } from '../src/theme/appTheme';
...
export default function FilterV() {
  ...
  const theme: FilterTheme = getFilterVTheme(darkMode);
    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView style={[styles.scroll, { backgroundColor: theme.background }]} contentContainerStyle={styles.scrollContent}>
        <View style={styles.containerfilter}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.textPrimary }]}>Habilidades</Text>

          {['Marketing', 'Vendas', 'Financeiro', 'Gestão', 'Outros'].map((habilidade) => (
